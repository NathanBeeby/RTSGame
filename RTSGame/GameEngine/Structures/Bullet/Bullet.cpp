...
//Bullet::Bullet(int ElementNo, int LevelNo, sf::Vector2i StartPos, sf::Vector2i GoalPos)
//{
//	//this->initVariables(GoalPos);
//	//this->resizeStrings();
//	//this->initTextures(ElementNo);
//	//this->initSprites(StartPos, ElementNo);
//}
